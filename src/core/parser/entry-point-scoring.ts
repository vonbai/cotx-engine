...
export function isTestFile(filePath: string): boolean {
  ...
  return (
    ...
    normalizedPath.includes('/uitests/') ||
    // C# test patterns
    p.endsWith('tests.cs') ||
    p.endsWith('test.cs') ||
    normalizedPath.includes('.tests/') ||
    normalizedPath.includes('.test/') ||
    normalizedPath.includes('.integrationtests/') ||
    normalizedPath.includes('.unittests/') ||
    normalizedPath.includes('/testproject/') ||
    // PHP/Laravel test patterns
    p.endsWith('test.php') ||
    p.endsWith('spec.php') ||
    normalizedPath.includes('/tests/feature/') ||
    normalizedPath.includes('/tests/unit/') ||
    // Ruby test patterns
    p.endsWith('_spec.rb') ||
    p.endsWith('_test.rb') ||
